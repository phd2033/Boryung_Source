...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_REG_SIMPLE_CLEAN_GROUP
    /// </summary>
    public partial class BR_BRS_REG_SIMPLE_CLEAN_GROUP : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            private string _NEW_GROUPNAME;
            [BizActorInputItemAttribute()]
            public string NEW_GROUPNAME
            {
                get
                {
                    return this._NEW_GROUPNAME;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._NEW_GROUPNAME = value;
                        this.CheckIsOriginal("NEW_GROUPNAME", value);
                        this.OnPropertyChanged("NEW_GROUPNAME");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_REG_SIMPLE_CLEAN_GROUP()
        {
            RuleName = "BR_BRS_REG_SIMPLE_CLEAN_GROUP";
            BizName = "BR_BRS_REG_SIMPLE_CLEAN_GROUP";
