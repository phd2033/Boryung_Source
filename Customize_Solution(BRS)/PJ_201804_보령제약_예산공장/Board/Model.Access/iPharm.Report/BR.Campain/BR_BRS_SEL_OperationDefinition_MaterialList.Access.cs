...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_OperationDefinition_MaterialList
    /// </summary>
    public partial class BR_BRS_SEL_OperationDefinition_MaterialList : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            private string _FILTERTYPE_CODE;
            [BizActorInputItemAttribute()]
            public string FILTERTYPE_CODE
            {
                get
                {
                    return this._FILTERTYPE_CODE;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._FILTERTYPE_CODE = value;
                        this.CheckIsOriginal("FILTERTYPE_CODE", value);
                        this.OnPropertyChanged("FILTERTYPE_CODE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            private string _FILTERTYPE_NAME;
            [BizActorInputItemAttribute()]
            public string FILTERTYPE_NAME
            {
                get
                {
                    return this._FILTERTYPE_NAME;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._FILTERTYPE_NAME = value;
                        this.CheckIsOriginal("FILTERTYPE_NAME", value);
                        this.OnPropertyChanged("FILTERTYPE_NAME");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_OperationDefinition_MaterialList()
        {
            RuleName = "BR_BRS_SEL_OperationDefinition_MaterialList";
            BizName = "BR_BRS_SEL_OperationDefinition_MaterialList";
