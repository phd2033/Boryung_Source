...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrder_OPSG_Component_Summary
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrder_OPSG_Component_Summary : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public System.Nullable<decimal> DISPQTY
            {
                ...
                set
                {
                    ...
                    {
                        this._DISPQTY = value;
                        this.CheckIsOriginal("DISPQTY", value);
                        this.OnPropertyChanged("DISPQTY");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrder_OPSG_Component_Summary()
        {
            RuleName = "BR_BRS_SEL_ProductionOrder_OPSG_Component_Summary";
            BizName = "BR_BRS_SEL_ProductionOrder_OPSG_Component_Summary";
