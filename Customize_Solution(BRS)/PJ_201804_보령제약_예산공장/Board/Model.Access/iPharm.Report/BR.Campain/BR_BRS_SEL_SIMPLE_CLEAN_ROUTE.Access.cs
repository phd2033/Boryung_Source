...
namespace LGCNS.iPharmMES.Common
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_SIMPLE_CLEAN_ROUTE
    /// </summary>
    public partial class BR_BRS_SEL_SIMPLE_CLEAN_ROUTE : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            public string GROUPNAME
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("GROUPNAME", value);
            ...
            private System.Nullable<bool> _ISDETAILED;
            [BizActorInputItemAttribute()]
            public System.Nullable<bool> ISDETAILED
            {
                get
                {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("ISDETAILED", value);
                        this.OnPropertyChanged("ISDETAILED");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string ROUTEGUID
            {
                ...
                set
                {
                    ...
                    {
                        this._ROUTEGUID = value;
                        this.CheckIsOriginal("ROUTEGUID", value);
                        this.OnPropertyChanged("ROUTEGUID");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        {
            RuleName = "BR_BRS_SEL_SIMPLE_CLEAN_ROUTE";
            BizName = "BR_BRS_SEL_SIMPLE_CLEAN_ROUTE";
