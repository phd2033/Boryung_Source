...
namespace 보령
{
    public class 최종조제V2ViewModel : ViewModelBase
    {
        #region [Property]
        public 최종조제V2ViewModel()
        {
            ...
            _BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2 = new BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2();
        ...
        private BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2.INDATA_SOLUTION _BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2_ori;
        #endregion
        #region [BizRule]
        ...
        private BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2 _BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2;
                ...
                return new AsyncCommandBase(async arg =>
                {
                    using (await AwaitableLocks["LoadedCommand"].EnterAsync())
                    {
                        try
                        {
                            ...
                            if (arg != null && arg is 최종조제V2)
                            {
                                _mainWnd = arg as 최종조제V2;
                                _mainWnd.Closed += (s, e) =>
                                {
                        ...
                        try
                        {
                            ...
                            switch (_curstate)
                            {
                                ...
                                case state.add:
                                    ...
                                    {
                                        _BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2_ori = new BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2.INDATA_SOLUTION
                                        {
                                            LOTTYPE = "WIP",
                                            POID = _mainWnd.CurrentOrder.ProductionOrderID,
                                            OPSGGUID = new Guid(_mainWnd.CurrentOrder.OrderProcessSegmentID),
                ...
                return new AsyncCommandBase(async arg =>
                {
                    using (await AwaitableLocks["DispensingCommandAsync"].EnterAsync())
                    {
                        try
                        {
                            ...
                            // 최종 조제시 보충원료 소분 및 투입
                            _BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2.INDATA_SOLUTIONs.Clear();
                            _BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2.INDATA_SOLUTIONs.Add(_BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2_ori.Copy());

                            _BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2.INDATAs.Clear();
                            _BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2.INDATAs.Add(new BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2.INDATA
                            {
                                POID = _mainWnd.CurrentOrder.ProductionOrderID,
                                WEIGHINGMETHOD = "WH007"
                            });
                            ...
                            if(await _BR_BRS_REG_ProductionOrderOutput_LastSoluction_V2.Execute())
                            {
                                DispensingbtnEnable = false;
