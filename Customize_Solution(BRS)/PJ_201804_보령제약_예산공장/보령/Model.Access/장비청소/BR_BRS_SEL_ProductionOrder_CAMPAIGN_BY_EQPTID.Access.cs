...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_ProductionOrder_CAMPAIGN_BY_EQPTID
    /// </summary>
    public partial class BR_BRS_SEL_ProductionOrder_CAMPAIGN_BY_EQPTID : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            public string ROOMEQUIPYN
            {
                ...
                set
                {
                    ...
                    {
                        this._ROOMEQUIPYN = value;
                        this.CheckIsOriginal("ROOMEQUIPYN", value);
                        this.OnPropertyChanged("ROOMEQUIPYN");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string CAMPAIGNCNT
            {
                ...
                set
                {
                    ...
                    {
                        this._CAMPAIGNCNT = value;
                        this.CheckIsOriginal("CAMPAIGNCNT", value);
                        this.OnPropertyChanged("CAMPAIGNCNT");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string CAMPAIGNPERIOD
            {
                ...
                set
                {
                    ...
                    {
                        this._CAMPAIGNPERIOD = value;
                        this.CheckIsOriginal("CAMPAIGNPERIOD", value);
                        this.OnPropertyChanged("CAMPAIGNPERIOD");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_ProductionOrder_CAMPAIGN_BY_EQPTID()
        {
            RuleName = "BR_BRS_SEL_ProductionOrder_CAMPAIGN_BY_EQPTID";
            BizName = "BR_BRS_SEL_ProductionOrder_CAMPAIGN_BY_EQPTID";
