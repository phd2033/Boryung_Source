...
namespace 보령
{
    ...
    public partial class BR_BRS_SEL_SVP_ASEPTIC_PROCESS : BizActorRuleBase
    {
        ...
        public sealed partial class BRS_SEL_SVP_ASEPTIC_PROCESS_RSLTDTCollection : BufferedObservableCollection<BRS_SEL_SVP_ASEPTIC_PROCESS_RSLTDT>
        {
        }
        private BRS_SEL_SVP_ASEPTIC_PROCESS_RSLTDTCollection _BRS_SEL_SVP_ASEPTIC_PROCESS_RSLTDTs;
        [BizActorOutputSetAttribute()]
        public BRS_SEL_SVP_ASEPTIC_PROCESS_RSLTDTCollection BRS_SEL_SVP_ASEPTIC_PROCESS_RSLTDTs
        {
            get
            {
                return this._BRS_SEL_SVP_ASEPTIC_PROCESS_RSLTDTs;
            }
        }
        [BizActorOutputSetDefineAttribute(Order="0")]
        [CustomValidation(typeof(ViewModelBase), "ValidateRow")]
        public partial class BRS_SEL_SVP_ASEPTIC_PROCESS_RSLTDT : BizActorDataSetBase
        {
            public BRS_SEL_SVP_ASEPTIC_PROCESS_RSLTDT()
            {
                RowLoadedFlag = false;
            }
            private bool _RowLoadedFlag;
        ...
        public BR_BRS_SEL_SVP_ASEPTIC_PROCESS()
        {
            ...
            _BRS_SEL_SVP_ASEPTIC_PROCESS_RSLTDTs = new BRS_SEL_SVP_ASEPTIC_PROCESS_RSLTDTCollection();
        }
    }
}
