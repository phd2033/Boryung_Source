...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_BRS_SEL_DrugSubstance_LABEL_HISTORY
    /// </summary>
    public partial class BR_BRS_SEL_DrugSubstance_LABEL_HISTORY : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            public string LABEL_GUID
            {
                ...
                set
                {
                    ...
                    {
                        this._LABEL_GUID = value;
                        this.CheckIsOriginal("LABEL_GUID", value);
                        this.OnPropertyChanged("LABEL_GUID");
                        if (RowLoadedFlag)
                        {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string LABEL_TYPE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("LABEL_TYPE", value);
            ...
            private System.Nullable<short> _PRINTCNT;
            [BizActorOutputItemAttribute()]
            public System.Nullable<short> PRINTCNT
            {
                get
                {
                    return this._PRINTCNT;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._PRINTCNT = value;
                        this.CheckIsOriginal("PRINTCNT", value);
                        this.OnPropertyChanged("PRINTCNT");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_SEL_DrugSubstance_LABEL_HISTORY()
        {
            RuleName = "BR_BRS_SEL_DrugSubstance_LABEL_HISTORY";
            BizName = "BR_BRS_SEL_DrugSubstance_LABEL_HISTORY";
