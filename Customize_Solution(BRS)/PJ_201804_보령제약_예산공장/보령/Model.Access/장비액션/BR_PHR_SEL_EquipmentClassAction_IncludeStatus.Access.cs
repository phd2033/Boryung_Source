...
namespace 보령
{
    ...
    /// <summary>
    /// summary of BR_PHR_SEL_EquipmentClassAction_IncludeStatus
    /// </summary>
    public partial class BR_PHR_SEL_EquipmentClassAction_IncludeStatus : BizActorRuleBase
    {
        ...
        public partial class INDATA : BizActorDataSetBase
        {
            ...
            private string _ISSYSACTVISIBLE;
            [BizActorInputItemAttribute()]
            public string ISSYSACTVISIBLE
            {
                get
                {
                    return this._ISSYSACTVISIBLE;
                }
                set
                {
                    if ((this.IsValid(value) == LGCNS.iPharmMES.Common.Common.enumValidationLevel.Error))
                    ...
                    {
                        this._ISSYSACTVISIBLE = value;
                        this.CheckIsOriginal("ISSYSACTVISIBLE", value);
                        this.OnPropertyChanged("ISSYSACTVISIBLE");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
            ...
            public string EQACSTATE
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("EQACSTATE", value);
        ...
        public BR_PHR_SEL_EquipmentClassAction_IncludeStatus()
        {
            RuleName = "BR_PHR_SEL_EquipmentClassAction_IncludeStatus";
            BizName = "BR_PHR_SEL_EquipmentClassAction_IncludeStatus";
