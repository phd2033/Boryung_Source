...
namespace 보령
{
    public class 재포장선별공정수율ViewModel : ViewModelBase
    {
        #region Properties

        재포장선별공정수율 _mainWndXml;
        ...
        BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK _BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK;
        public BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK
        {
            get { return _BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK; }
            set { _BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK = value; }
        }
                    ...
                    using (await AwaitableLocks["LoadedCommand"].EnterAsync())
                    {
                        try
                        {
                            ...
                            if (arg != null)
                            {
                                ...
                                _BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK.INDATAs.Clear();
                                _BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK.OUTDATAs.Clear();

                                _BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK.INDATAs.Add(new BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK.INDATA()
                                {
                                ...
                                await _BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK.Execute();


                                //재포장선별공정수율 = 선별반제품 / (해체공정반제품무게  ÷  해체공정 평균질량) * 100

                                if (_BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK.OUTDATAs.Count > 0)
                                {

                                    Result_IN = _BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK.OUTDATAs[0].IN_VALUE;
                                    Result_OUT = _BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK.OUTDATAs[0].OUT_VALUE;
                                    Result_SUM = _BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK.OUTDATAs[0].SUM.HasValue ? MathExt.Round(_BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK.OUTDATAs[0].SUM.Value, PRECISION, MidpointRounding.AwayFromZero) : 0m;
        ...
        public 재포장선별공정수율ViewModel()
        {
            _BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK_REWORK = new BR_BRS_SEL_Yield_Calculation_Weight_Selection_REWORK();
