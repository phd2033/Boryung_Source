    ...
    public class 무균공정시트조회_액상ViewModel : ViewModelBase
    {
        ...
        public void ValueMapping()
        {
            try
            {
                ...
                FillDiff = !string.IsNullOrEmpty(_BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].FillDiff) && _BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].FillDiff.ToString().Equals("Y") ? "Red" : "#FFEBEEEE";
                ...
                AsepticDiff = !string.IsNullOrEmpty(_BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].AsepticDiff) && _BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].AsepticDiff.ToString().Equals("Y") ? "Red" : "#FFEBEEEE";
