...
namespace º¸·É
{
    ...
    /// <summary>
    /// summary of BR_BRS_GET_WATERS_BMS_INFO
    /// </summary>
    public partial class BR_BRS_GET_WATERS_BMS_INFO : BizActorRuleBase
    {
        ...
        public partial class OUTDATA : BizActorDataSetBase
        {
            ...
            public string ITEM
            {
                ...
                set
                {
                    ...
                    {
                        this._ITEM = value;
                        this.CheckIsOriginal("ITEM", value);
            ...
            public string POSITION
            {
                ...
                set
                {
                    ...
                    else
                    {
                        ...
                        this.CheckIsOriginal("POSITION", value);
            ...
            public string ALERT
            {
                ...
                set
                {
                    ...
                    {
                        this._ALERT = value;
                        this.CheckIsOriginal("ALERT", value);
            ...
            public string CV
            {
                ...
                set
                {
                    ...
                    {
                        this._CV = value;
                        this.CheckIsOriginal("CV", value);
                        this.OnPropertyChanged("CV");
                        if (RowLoadedFlag)
                        {
                            if (this.CheckIsOriginalRow())
                            {
        ...
        public BR_BRS_GET_WATERS_BMS_INFO()
        {
            RuleName = "BR_BRS_GET_WATERS_BMS_INFO";
            BizName = "BR_BRS_GET_WATERS_BMS_INFO";
