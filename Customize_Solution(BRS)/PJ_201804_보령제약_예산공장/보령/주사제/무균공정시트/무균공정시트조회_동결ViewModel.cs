    ...
    public class 무균공정시트조회_동결ViewModel : ViewModelBase
    {
        ...
        public void ValueMapping()
        {
            try
            {
                ...
                AutoDiff = !string.IsNullOrEmpty(_BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].AutoDiff) && _BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].AutoDiff.ToString().Equals("Y") ? "Red" : "#FFEBEEEE";
                ...
                IsolatorHoldDiff = !string.IsNullOrEmpty(_BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].IsolatorHoldDiff) &&_BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].IsolatorHoldDiff.ToString().Equals("Y") ? "Red" : "#FFEBEEEE";
                ...
                SetDiff = !string.IsNullOrEmpty(_BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].SETDiff) && _BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].SETDiff.ToString().Equals("Y") ? "Red" : "#FFEBEEEE";
                ...
                StableDiff = !string.IsNullOrEmpty(_BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].StableDiff) && _BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].StableDiff.ToString().Equals("Y") ? "Red" : "#FFEBEEEE";
                ...
                FillDiff_FDR = !string.IsNullOrEmpty(_BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].FillDiff_FDR) && _BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].FillDiff_FDR.ToString().Equals("Y") ? "Red" : "#FFEBEEEE";
                ...
                AsepticDiff_FDR = !string.IsNullOrEmpty(_BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].AsepticDiff_FDR) && _BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].AsepticDiff_FDR.ToString().Equals("Y") ? "Red" : "#FFEBEEEE";
                ...
                DryHoldDiff = !string.IsNullOrEmpty(_BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].DryHoldDiff) && _BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].DryHoldDiff.ToString().Equals("Y") ? "Red" : "#FFEBEEEE";
                ...
                FreezeDiff = !string.IsNullOrEmpty(_BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].FreezeDiff) && _BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].FreezeDiff.ToString().Equals("Y") ? "Red" : "#FFEBEEEE";
                ...
                BlockDiff = !string.IsNullOrEmpty(_BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].BlockDiff) && _BR_BRS_SEL_SVP_ASEPTIC_PROCESS.OUTDATAs[0].BlockDiff.ToString().Equals("Y") ? "Red" : "#FFEBEEEE";
